...
public class NotificationManager extends BroadcastReceiver {
    ...
    private Notification createNotification() {
        ...
        if ((mPlaybackState.getActions() & PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS) != 0) {
            builder.addAction(R.drawable.ic_sp_skip_previous_black,
        ...
        if ((mPlaybackState.getActions() & PlaybackStateCompat.ACTION_SKIP_TO_NEXT) != 0) {
            builder.addAction(R.drawable.ic_sp_skip_next_black,
                    mPlayerService.getString(R.string.label_next), mNextIntent);
        }

        builder.addAction(R.drawable.ic_sp_close_black,
    ...
    private void addPlayPauseAction(NotificationCompat.Builder builder) {
        ...
        if (mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING) {
            ...
            icon = R.drawable.ic_sp_pause_black;
            intent = mPauseIntent;
        } else {
            label = mPlayerService.getString(R.string.label_play);
            icon = R.drawable.ic_sp_play_arrow_black;
            intent = mPlayIntent;
        }
